...
- `insertAllColumns(data1, data2...)`: inserts data into each columns within the table respectively and matches all columns to the same length using placeholder null
